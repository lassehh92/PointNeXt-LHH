...
#    ]
methods_dir = [
	'log/s3dis/s3dis-train-pointnext-xl-ngpus1-seed1045-20221008-170028-9LKswMZCFEnShmwcCgsFdY_ckpt_best.pth_20221008-233159-CiCAoPyMoVReUYhFcoHAM4/visualization'
	]
...
prefix_names = ['input-s3dis-Area5-','gt-s3dis-Area5-','pred-s3dis-Area5-']
idx = 3
